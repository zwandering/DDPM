...
diffusion.model.load_state_dict(torch.load('/home/huteng/DDPM2/results3/sketches/clip_center_loss/step=300,beta_f=1,beta_s=1/models/17000.pth'),strict=True)
